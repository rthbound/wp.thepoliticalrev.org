	...
	public function settings_enable_or_disable_output() {
		...
		?>
			<div class="simbatfa_frontend_settings_box tfa_settings_form">
				...
				<button style="margin-left: 4px;margin-bottom: 10px" class="button button-primary simbatfa_settings_save"><?php echo __('Save Settings', 'two-factor-authentication'); ?></button>
			</div>
		<?php
	}
