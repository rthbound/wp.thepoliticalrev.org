    ...
    <footer id="footer">
            <div>
                <ul class="icons">
                    ...
                    <li><a href="{{ site.medium_url }}" class="icon fa-medium" target="_blank"><span class="label">Medium</span></a></li>
                    <li><a href="{{ site.slack_url }}" class="icon fa-slack" target="_blank"><span class="label">Slack</span></a></li>
                    <li><a href="{{ site.subreddit_url }}" class="icon fa-reddit-alien" target="_blank"><span class="label">LinkedIn</span></a></li>
                </ul>
            </div>
            <div>
